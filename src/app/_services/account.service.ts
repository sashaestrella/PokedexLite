...
import { Account, Pokemon} from '@app/_models';

const baseUrl = `${environment.apiUrl}/accounts`;
const baseUrl2 = `${environment.apiUrl}/pokemons`;
...
export class AccountService {
    ...
    constructor(
        ...
        this.pokemonSubject = new BehaviorSubject<Pokemon>(null);
    ...
    public get pokemonValue(): Pokemon {
    ...
    updatePokemon(id, params) {
      return this.http.put(`${baseUrl}/${id}`, params)
          .pipe(map((pokemon: Pokemon) => {
              if (pokemon.id === this.pokemonValue.id) {
                  pokemon = { ...this.pokemonValue, ...pokemon };
